...
- [Low Issues](#low-issues)
  ...
  - [L-8: Loop condition contains `state_variable.length` that could be cached outside.](#l-8-loop-condition-contains-statevariablelength-that-could-be-cached-outside)
...
## L-8: Loop condition contains `state_variable.length` that could be cached outside.
